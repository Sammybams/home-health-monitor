...
|---|---|---|
| Status | Current installed development default | Trained development candidate |
...
eight-minute aggregation on a development computer. V1 remains the installed
default until the exact wearable feature formulas/BLE payload are confirmed and
V2 latency and memory are measured on the target Pi. The registry default changes
only after those two gates pass.
